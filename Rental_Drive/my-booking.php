...
<title>Rental Drive - My Booking</title>
...
<li>
    <h4 style="color:red">Booking No #<?php echo htmlentities($result->BookingNumber);?></h4>
                <div class="vehicle_img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->vid);?>"><img src="assets/images/vehicles/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
