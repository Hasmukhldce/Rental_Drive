<?php 
  ...
  if(isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO tblvehicles(VehiclesTitle, VehiclesBrand, VehiclesOverview, PricePerDay, FuelType, ModelYear, SeatingCapacity, Vimage1, Vimage2, Vimage3, Vimage4, Vimage5, NoOfOwner, KmDriven, EngineType, EngineDescription, FuelCapacity, Transmission, Cylinders, MileageCity, MileageHighway, AirConditioner, PowerDoorLocks, AntiLockBrakingSystem, BrakeAssist, PowerSteering, DriverAirbag, PassengerAirbag, PowerWindows, CDPlayer, CentralLocking, CrashSensor, LeatherSeats, EngineCheckWarning, AutomaticHeadlamps, PostedBy) VALUES(:vehicletitle,:brand,:vehicleoverview,:priceperday,:fueltype,:modelyear,:seatingcapacity,:vimage1,:vimage2,:vimage3,:vimage4,:vimage5,:noofowner,:kmdriven,:enginetype,:enginedescription,:fuelcapacity,:transmission,:cylinders,:milagecity,:mileagehighway,:airconditioner,:powerdoorlocks,:antilockbrakingsys,:brakeassist,:powersteering,:driverairbag,:passengerairbag,:powerwindow,:cdplayer,:centrallocking,:crashcensor,:leatherseats, :enginecheckwarning, :automaticheadlamps, :postedby)";
         ...
         <?php } else if(isset($error) && $error != "") { ?>
          ...
          <form action="#" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input class="form-control white_bg" id="VehiclesTitle" name="VehiclesTitle" type="text">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control white_bg" name="VehiclesOverview" rows="5"></textarea>
            </div>
            <div class="form-group">
              <label class="control-label">Price ($)</label>
              <input class="form-control white_bg" id="PricePerDay" name="PricePerDay" type="text">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" id="year" name="ModelYear" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">No. of Owners</label>
              <input class="form-control white_bg" id="owners" name="NoOfOwner" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">KMs Driven</label>
              <input class="form-control white_bg" id="kws" name="KmDriven" type="text">
            </div>
            <div class="gray-bg field-title">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" id="engien" name="EngineType" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">Engine Description</label>
              <input class="form-control white_bg" id="engien-description" name="EngineDescription" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">Fuel Type</label>
              <input class="form-control white_bg" id="fuel" name="FuelType" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">Fuel Tank Capacity</label>
              <input class="form-control white_bg" id="capacity" name="FuelCapacity" type="text">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" id="mileage" name="MileageCity" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">Mileage-Highway</label>
              <input class="form-control white_bg" id="mileage-h" name="MileageHighway" type="text">
            </div>
            <div class="form-group">
              <label class="control-label">Seating Capacity</label>
              <input class="form-control white_bg" id="s-capacity" name="SeatingCapacity" type="text">
            </div>
            <div class="gray-bg field-title">
              <h6>Accessories</h6>
            </div>
